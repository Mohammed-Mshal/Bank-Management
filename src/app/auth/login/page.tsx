...
export default async function LoginPage() {
  ...
  if (session?.userId) {
    ...
    return (
      <div className="login_page overflow-hidden relative px-4 flex justify-center items-center min-h-screen min-w-full before:absolute before:top-0 before:left-0 before:h-full before:w-full bg-[#0C0C0C] before:bg-[#1919191f]  before:-z-10 before:backdrop-filter before:backdrop-blur-3xl z-0">
        ...
        <div className="container max-w-md mx-auto px-8 bg-[var(--normal-black)] p-8 rounded-xl">
          <div className="headerForm text-center  text-white mb-8">
            <h2 className="lg:text-4xl md:text-3xl text-2xl mb-2">
              Golden Bank
            </h2>
